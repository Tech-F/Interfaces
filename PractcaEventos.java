...
public class PractcaEventos extends JFrame {
        ...
        public PractcaEventos() {
                ...
                1.0,GridBagConstraints.NONE,GridBagConstraints.NORTHWEST,new Insets(4, 10, 10, 4)));JBcalc.setEnabled(false); // Poner el bot�n de calcular desactivado hasta elegir una operacion
                ...
                JBcalc.addActionListener(oyenteBoton);

                OyenteItem oyenteItem =new OyenteItem();
            ...
            class OyenteItem implements ItemListener{
                ...
                public void itemStateChanged(ItemEvent e) {
                    ...
                    CHBsuma = (Checkbox) e.getItem();
                    CHBresta = (Checkbox) e.getItem();
                    CHBmultiplicacion = (Checkbox) e.getItem();
                    CHBdivision = (Checkbox) e.getItem();
                }
            ...
            class OyenteAccion implements ActionListener {
                ...
                public void actionPerformed(ActionEvent evento) {
                    ...
                    JBcalc = (JButton) evento.getSource();
                    //Aqui tengo que añadir que esta seleccionado de antes
                    Racional2 resultado=new Racional2();
                    Racional2 n1= new Racional2(Integer.parseInt(JTFnum1.getText()),Integer.parseInt(JTFden1.getText()));
                    Racional2 n2= new Racional2(Integer.parseInt(JTFnum2.getText()),Integer.parseInt(JTFden2.getText()));
        ...
        public static void main(String[] args) {
                PractcaEventos ventana = new PractcaEventos();
